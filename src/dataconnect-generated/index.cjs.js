...
const getMoviesFromListRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetMoviesFromList', inputVars);
}
getMoviesFromListRef.operationName = 'GetMoviesFromList';
exports.getMoviesFromListRef = getMoviesFromListRef;

exports.getMoviesFromList = function getMoviesFromList(dcOrVars, vars) {
