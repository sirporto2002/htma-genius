const { createNewUserRef, getPublicListsRef, addMovieToListRef, getMoviesFromListRef, connectorConfig } = require('../index.cjs.js');
...
exports.useGetMoviesFromList = function useGetMoviesFromList(dcOrVars, varsOrOptions, options) {
